...
parser = argparse.ArgumentParser(description='Update errant vcf header using a correct file, and table.')
parser.add_argument('-i', '--input_vcf_list', action='store', dest='in_vcf', help='Input vcf list to fix')
...
# for fname in open(args.in_vcf):
#     mt_file_process(fname)
